  ...
  return (
    <section className="w-full pt-10">
      ...
      <div className="flex flex-col md:flex-row justify-center items-stretch gap-0">
        <div className="flex-1 bg-yellow-100 p-8 shadow-md text-center">
        ...
        <div className="flex-1 bg-blue-100 p-8 shadow-md text-center">
        ...
        <div className="flex-1 bg-green-100 p-8 shadow-md text-center">
